...
<body>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <table class="table bootstrap-datatable countries">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="<%=application.getContextPath()%>/resources/admin_page_resource/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Germany</td>
                      <td>2563</td>
                      <td>1025</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="<%=application.getContextPath()%>/resources/admin_page_resource/img/India.png" style="height:18px; margin-top:-2px;"></td>
                      <td>India</td>
                      <td>3652</td>
                      <td>2563</td>
                      <td>
                    ...
                    <tr>
                      <td><img src="<%=application.getContextPath()%>/resources/admin_page_resource/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                      <td>Spain</td>
                      <td>562</td>
                      <td>452</td>
                      <td>
                  ...
                  <ul class="chats">
                    ...
                    <li class="by-me">
                      ...
                      <div class="avatar pull-left">
                        <img src="<%=application.getContextPath()%>/resources/admin_page_resource/img/user.jpg" alt="" />
                      </div>
                    ...
                    <li class="by-other">
                      ...
                      <div class="avatar pull-right">
                        <img src="<%=application.getContextPath()%>/resources/admin_page_resource/img/user22.png" alt="" />
                      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="<%=application.getContextPath()%>/resources/admin_page_resource/img/avatar1_small.jpg">
                                        Jenifer smith
                                </span>
                  </div>
                </div>
  ...
  <!-- javascripts -->
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.js"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery-ui-1.10.4.min.js"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery-1.8.3.min.js"></script>
  <script type="text/javascript" src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery-ui-1.9.2.custom.min.js"></script>
  <!-- bootstrap -->
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/bootstrap.min.js"></script>
  <!-- nice scroll -->
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.scrollTo.min.js"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.nicescroll.js" type="text/javascript"></script>
  <!-- charts scripts -->
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/assets/jquery-knob/js/jquery.knob.js"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.sparkline.js" type="text/javascript"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
  <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/owl.carousel.js"></script>
  <!-- jQuery full calendar -->
  <<script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/fullcalendar.min.js"></script>
    <!-- Full Google Calendar - Calendar -->
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
    <!--script for this page only-->
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/calendar-custom.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.rateit.min.js"></script>
    <!-- custom select -->
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.customSelect.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/assets/chart-master/Chart.js"></script>

    <!--custome script for all page-->
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/scripts.js"></script>
    <!-- custom script for this page-->
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/sparkline-chart.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/easy-pie-chart.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/xcharts.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.autosize.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.placeholder.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/gdp-data.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/morris.min.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/sparklines.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/charts.js"></script>
    <script src="<%=application.getContextPath()%>/resources/admin_page_resource/js/jquery.slimscroll.min.js"></script>
    <script>
      //knob
      $(function() {
        $(".knob").knob({
...
>>>>>>> 28abaee29fdb5a96b24dee8e6eb6f2740f3819eb
